// python => 대부분이 class 로 되어 있죠?
// javascript => class 가 ES6 부터 나온 문법입니다. 원래 있던 문법이 아닙니다.
...
// robot1 instanceof Factory // 인스턴스 인지 확인
...
// 우리는 100개의 객체를 생성할때마다 역시 100개의 함수를 새로 만들고 있는것 입니다.
...
// 생성자 함수를 만들게 되면 위에서 child가 parent 를 상속 받았기 때문에
// child 가 parent 의 메서드나 멤버를 사용할 수 있다.
let 자식1 = new Child()
자식1.rename('호돌돌')
자식1.sayName()
